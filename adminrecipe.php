...
<body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="adminmain.php"><img src="mainrecipe.jpg" class="img-responsive img-wrapper" alt="Responsive"></a>
				</div>
				<div class="col-lg-2 col-md-2 col-xs-2"></div>
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="admindess.php"><img src="dessert.jpeg" class="img-responsive img-wrapper" alt="Responsive"></a>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-1 col-md-1 col-xs-1"></div>
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="adminmain.php"><h3> Main Courses </h3></a>
				</div>
				<div class="col-lg-2 col-md-2 col-xs-2"></div>
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="admindess.php"><h3> Dessert </h3></a>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="adminside.php"><img src="side.jpg" class="img-responsive img-wrapper" alt="Responsive"></a>
				</div>
				<div class="col-lg-2 col-md-2 col-xs-2"></div>
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="adminother.php"><img src="other.jpg" class="img-responsive img-wrapper" alt="Responsive"></a>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-1 col-md-1 col-xs-1"></div>
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="adminside.php"><h3> Side Dishes </h3></a>
				</div>
				<div class="col-lg-2 col-md-2 col-xs-2"></div>
				<div class="col-lg-4 col-md-4 col-xs-4">
					<a href="adminother.php"><h3> Others </h3></a>
				</div>
			</div>
